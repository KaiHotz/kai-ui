import{r as E,R as e}from"./index-CDs2tPxN.js";import{u as R,b as F,c as v,a as g,F as y}from"./Form-BuIgr2gz.js";import{R as S,a as r}from"./RadioOption-C6UIio0x.js";import"./clsx-B-dksMZM.js";import"./Hint-CwrnwYvC.js";import"./lodash-B2soob2o.js";import"./Label-5g4jD_uN.js";const m=({name:o,errorMsg:a,children:l,...i})=>{const{control:t,setError:p}=R(),{field:{value:f,onChange:b},fieldState:{error:s}}=F({name:o,control:t});return E.useEffect(()=>{a&&p(o,a)},[o,p,a]),e.createElement(S,{...i,selected:f,onChange:b,errorMsg:s==null?void 0:s.message},l)};m.__docgenInfo={description:"",methods:[],displayName:"FormRadio",props:{name:{required:!0,tsType:{name:"string"},description:""},errorMsg:{required:!1,tsType:{name:"FieldError"},description:""}},composes:["Omit"]};const C={title:"Components/Forms/FormRadio",component:m,argTypes:{labelPosition:{options:["left","right"]},variant:{options:[void 0,"text"]},name:{control:!1},selected:{control:!1}}},n={render:o=>{const a=v({formRadioExample:g()}),l=t=>{alert(JSON.stringify(t))},i=t=>{console.log(t)};return e.createElement(y,{validationSchema:a,defaultValues:{formRadioExample:"option_1"},onSubmit:l,onError:i},e.createElement(m,{...o,name:"formRadioExample"},e.createElement(r,{value:"option_1",label:"Label 1"}),e.createElement(r,{value:"option_2",label:"Label 2"}),e.createElement(r,{value:"option_3",label:"Label 3"}),e.createElement(r,{value:"option_4",label:"Label 4",disabled:!0})),e.createElement("button",{type:"submit"},"Submit"))},args:{variant:void 0,labelPosition:"left",hintText:"",disabled:!1,isInline:!1,reserveSpaceForError:!1}};var d,c,u;n.parameters={...n.parameters,docs:{...(d=n.parameters)==null?void 0:d.docs,source:{originalSource:`{
  render: args => {
